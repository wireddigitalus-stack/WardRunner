...
export default function RouteDetailCard({
  ...
  return (
    <CampaignWindowFrame
      title={`Canvass Route ${route.precinct_code}`}
      subtitle={route.name}
      badge={isCompleted ? 'Completed' : isAssigned ? 'Assigned' : 'Unassigned'}
      badgeColor={
        isCompleted
    ...
    >
      {({ isDoubleSize }) => (
        <div className={isDoubleSize ? 'grid grid-cols-1 md:grid-cols-2 gap-5' : 'space-y-4'}>
          {/* Identity & Progress Column */}
          <div className="space-y-4">
            <div className="flex items-start gap-3.5">
              <div
                className={`w-14 h-14 rounded-2xl flex items-center justify-center text-xl shrink-0 shadow-lg ${
                  isCompleted
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-zinc-400 mt-0.5 flex items-center gap-2">
                  <span className="flex items-center gap-1">
                    ...
                    ~{route.estimated_walk_minutes}m
                  </span>
                  <span>•</span>
                  <span>{route.distance_miles}mi</span>
                  <span>•</span>
                  <span className="text-emerald-400 font-bold">{route.target_doors} Doors</span>
                </p>
              </div>
            </div>
            ...
            <div className="p-3 rounded-2xl bg-white/[0.04] border border-white/10 space-y-2">
              <div className="flex items-center justify-between text-xs font-semibold">
                <span className="text-zinc-400 flex items-center gap-1.5">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" /> Doors Knocked
                </span>
            ...
            <div className="flex items-center gap-2 pt-1">
              ...
              <a
                ...
                title="Apple Maps Walk Navigation"
              >
          ...
          {/* Volunteer Assignment & Waypoints Column */}
